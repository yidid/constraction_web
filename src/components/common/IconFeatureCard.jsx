...
const IconFeatureCard = ({ icon: Icon, title, description }) => {
  return (
    <div className="bg-light-off rounded-lg p-8 text-center hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
      <div className="w-14 h-14 flex items-center justify-center rounded-lg bg-dark mx-auto">
        <Icon className="text-primary text-2xl" />
      </div>
      <h3 className="text-lg font-bold text-dark mt-5">{title}</h3>
